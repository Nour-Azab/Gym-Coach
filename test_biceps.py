...
# Configuration
VIDEO_PATH = 0
MODEL_PATH = r"best_transformer_autoencoder_biceps22.pth"
SCALER_PATH = r"pose_scaler_biceps22.pkl"

WINDOW_SIZE = 30
NUM_FEATURES = 26  # Upper body: 14 landmarks × 3 (x,y,visibility) + 5 angles = 42/2 = 21 + 5=26
