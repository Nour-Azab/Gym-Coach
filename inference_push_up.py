...
# Configuration
VIDEO_PATH = r"D:\رواد\Push_ups\4.mp4"
MODEL_PATH = r"pushup_transformer_autoencoder.pth"
SCALER_PATH = r"pose_scaler_push_up.pkl"

WINDOW_SIZE = 30
NUM_FEATURES = 43  #  12 landmarks × 3 (x,y,visibility) +  7 angles = 36 + 7
...
def extract_pushup_angles_from_landmarks(landmarks_dict):
    ...
    # --- Torso-Hip Drift ---
    left_torso_hip_drift = left_hip[0] - left_shoulder[0]
    right_torso_hip_drift = left_hip[0] - left_shoulder[0]
...
while True:
    ...
    cv2.putText(frame, f"Frame: {rep_counter}", (10, 30),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (100, 200, 255), 2)
