...
def add_biceps_curl_angles(df):
    ...
    for _, row in df.iterrows():
        ...
        if active_arm == "left":
            ...
            if left_hip[0] is not None:
                torso_lean_angle.append(calculate_angle(left_hip, left_shoulder, vertical_point_left))
                upper_arm_torso_angle.append(calculate_angle(left_hip, left_shoulder, left_elbow))
            else:
                torso_lean_angle.append(0.0)
                upper_arm_torso_angle.append(0.0)
        ...
        # =============== RIGHT ACTIVE ===============
            ...
            if right_hip[0] is not None:
                torso_lean_angle.append(calculate_angle(right_hip, right_shoulder, vertical_point_right))
                upper_arm_torso_angle.append(calculate_angle(right_hip, right_shoulder, right_elbow))
            else:
                torso_lean_angle.append(0.0)
                upper_arm_torso_angle.append(0.0)
...
file_path = r"C:\Users\Abdallah\Desktop\biceps_curl\output.csv"
sheet_name = "rwaddd2"
...
BEST_MODEL_PATH = r"C:\Users\Abdallah\Desktop\biceps_curl\best_transformer_autoencoder_biceps22.pth"
FINAL_MODEL_PATH = r"C:\Users\Abdallah\Desktop\biceps_curl\transformer_autoencoder_biceps22.pth"
SCALER_PATH = r"C:\Users\Abdallah\Desktop\biceps_curl\pose_scaler_biceps22.pkl"
