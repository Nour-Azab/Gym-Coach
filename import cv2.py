...
# ------------------ Setup ------------------
VIDEO_PATH = r"C:\Users\hp\Desktop\squats\squat_11.mp4"
OUTPUT_FOLDER = r"C:\Users\hp\Desktop\pose_frames_squat_11"
CSV_FILE = r"C:\Users\hp\Desktop\pose_landmarks\squat_11.csv"
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    ...
    while True:
        ...
        if results.pose_landmarks:
            ...
            angle = (
                compute_angle_with_vertical(right_hip, right_knee)
                if right_vis > left_vis
                else compute_angle_with_vertical(left_hip, left_knee)
            )
